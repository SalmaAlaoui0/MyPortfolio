...
export const AnimatedNoBorder =({children}) => {
    return (
        <button
          className="relative bg-transparent border border-transparent
            text-foreground hover:border-primary/50 transition-all
            duration-1000 focus:outline-none focus-visible:ring-2
            focus-visible:ring-primary focus-visible:ring-offset-2
            disabled:opacity-50 cursor-pointer group
            px-2 py-2 text-lg font-medium rounded-full overflow-visible
            animated-border"
        >
            {/* Animated SVG Border */}
            <svg
