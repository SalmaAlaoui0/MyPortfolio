...
export const About = () => {
    const[isStrenth, setIsStrenth] = useState(true);
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
                ...
                <div className='space-y-8'>
                    ...
                    <div className="text-muted-foreground animation-menu-fade animation-delay-200">
                        ...
                        <div className="font-inria text-[1.5em]">
                ...
                <div className="flex flex-col gap-7 animation-menu-fade animation-delay-300">
                    ...
                    >
                        <ButtonV2
                            ...
                            className={`text-[1.4rem] transition-all duration-300 ${
                    ...
                    <div className="glass vision-border p-5 rounded-3xl animation-menu-fade animation-delay-400">
                        <div
                            className={`font-inria text-[1.1rem] md:text-[1.3rem] transition-opacity duration-800 
                            ${isStrenth ? "opacity-100 relative" : "opacity-0 absolute inset-0 pointer-events-none"}`}
                        > {/*  this div is for Strenth  */}
                            <h2 className="font-bold flex text-[2rem] justify-center">Soft Skills</h2>
                            <div className="grid sm:grid-cols-2 gap-15 mx-7 my-10">
                                {SoftSkills.map((item, idx) => (
                                    <div key={idx} className="glass border hover:border-primary/90 transition-all duration-400 hover:-translate-y-2 p-5 flex justify-center items-center rounded-2xl">
                                        {item.Skill}
                                    </div>
                                ))}
                            </div>
                        ...
                        > {/*  this div is for Journey  */}
                            {/* TimeLine Itself */}
                            <div className="timeline-glow absolute left-1/2 top-0 bottom-0 w-0.5 bg-linear-to-b from-primary to-transparent -translate-x-1/2 shadow-[0_0_25px_rgba(32,178,166,0.8)]" />
                            {/* TimeLine Items */}
                            <div className="space-y-10">
                                {Journey.map((exp, idx) => (
                                    <div
                                        key={idx}
                                        className="relative grid sm:grid-cols-2 animation-menu-fade"
                                    >
                                        {/* this is for the dots */}
                                        <div className="absolute left-1/2 top-0 w-3 h-3 bg-primary rounded-full -translate-x-1/2  ring-3 ring-background z-10"></div>
                                        {/* this is for the Journey content */}
                                        <div className={`pl-8 sm:pl-0 ${idx %2 === 0 ? "sm:pr-16 sm:text-right" : "sm:col-start-2 sm:pl-16 "}`}>
